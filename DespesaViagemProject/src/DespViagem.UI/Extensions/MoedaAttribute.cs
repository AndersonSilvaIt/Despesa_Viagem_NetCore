...
namespace DespViagem.UI.Extensions
{
	...
	public class MoedaAtributeAddapter : AttributeAdapterBase<MoedaAttribute>
	{
		public MoedaAtributeAddapter(MoedaAttribute attribute, IStringLocalizer stringLocalizer)
	...
	public class MoedaValidationAttributeAdapterProvider : IValidationAttributeAdapterProvider
	{
		...
		public IAttributeAdapter GetAttributeAdapter(ValidationAttribute attribute, IStringLocalizer stringLocalizer)
		{
			...
			{
				return new MoedaAtributeAddapter(moedaAttribute, stringLocalizer);
			}
